    ...
    function apresentarCliente(cliente) {
        ...
        var html = 
         '<div class="accordion active">' +
                       '<div class="accordion-header" onclick="toggleAccordion(this.parentNode)">' +
        ...
        html += '<div class="accordion">' +
                        ...
                        '<div class="accordion-content">' +
                        '<table>' +
                        '<tr><th>Logradouro</th><td>' + cliente.address.street + '</td></tr>' +
                        '<tr><th>Cidade</th><td>' + cliente.address.city + '</td></tr>' +
                        '<tr><th>Estado</th><td>' + cliente.address.state + '</td></tr>' +
                        '<tr><th>CEP</th><td>' + cliente.address.zipCode + '</td></tr>' +
                        '</table>' +
                        '</div>' +
                        '</div>';
